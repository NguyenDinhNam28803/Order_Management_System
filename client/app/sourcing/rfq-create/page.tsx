        ...
        <main className="animate-in fade-in duration-500 p-6 min-h-screen bg-[#FFFFFF] text-[#000000]">
            <div className="mt-8 flex justify-between items-end mb-8 border-b border-[rgba(148,163,184,0.1)] pb-4">
                <div className="flex items-center gap-6">
                    <button 
                        onClick={() => router.back()}
                        className="w-12 h-12 flex items-center justify-center rounded-2xl bg-[#F1F5F9] border border-[rgba(148,163,184,0.1)] text-[#000000] hover:text-[#2563EB] hover:border-[#2563EB]/30 transition-all shadow-sm"
                    >
                        <ArrowLeft size={20} />
                    </button>
                    <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="erp-card !p-8 shadow-sm border border-[rgba(148,163,184,0.1)] bg-[#F1F5F9]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="group">
                                <label className="flex items-center gap-2 text-[10px] font-black uppercase text-[#000000] tracking-widest mb-2.5 transition-colors group-focus-within:text-[#2563EB]">
                                    <User size={12} className="text-[#000000]/50 group-focus-within:text-[#2563EB]/50" />
                            ...
                            <div className="col-span-2 group">
                                <label className="flex items-center gap-2 text-[10px] font-black uppercase text-[#000000] tracking-widest mb-2.5 transition-colors group-focus-within:text-[#2563EB]">
                                    <Info size={12} className="text-[#000000]/50 group-focus-within:text-[#2563EB]/50" />
                ...
                <div className="space-y-6">
                    <div className="erp-card !p-8 shadow-xl border-t-4 border-t-emerald-500 bg-[#F1F5F9]">
                    ...
                    <div className="bg-gradient-to-br from-[#F1F5F9] to-[#FFFFFF] border border-[rgba(148,163,184,0.1)] rounded-[40px] p-10 text-[#000000] relative overflow-hidden shadow-2xl shadow-black/40 group hover:border-[#2563EB]/30 transition-all duration-500">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="space-y-6">
                                <div className="flex justify-between items-center bg-[#FFFFFF]/50 p-4 rounded-2xl border border-[rgba(148,163,184,0.05)]">
                                    ...
                                    <span className="font-black uppercase tracking-widest text-[#000000] bg-[#F1F5F9] px-3 py-1 rounded-lg border border-[rgba(148,163,184,0.1)]">{Array.from(new Set(form.items.map((i) => i.prId))).length} PRs</span>
                                </div>
                                <div className="flex justify-between items-center bg-[#FFFFFF]/50 p-4 rounded-2xl border border-[rgba(148,163,184,0.05)]">
                                    <span className="text-[#000000] font-bold text-xs">Tổng số dòng hàng</span>
                                    <span className="font-black uppercase tracking-widest text-[#000000] bg-[#F1F5F9] px-3 py-1 rounded-lg border border-[rgba(148,163,184,0.1)]">{form.items.length} Lines</span>
                                </div>
