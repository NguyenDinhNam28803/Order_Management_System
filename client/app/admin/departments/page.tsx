            ...
            <div className="bg-[#F1F5F9] rounded-xl border border-slate-200 shadow-xl shadow-[#2563EB]/5 overflow-hidden">
                <div className="p-8 bg-[#FFFFFF] border-b border-slate-200 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        <div className="text-[10px] font-black text-slate-900 uppercase tracking-widest border-r border-slate-200 pr-4">Cơ cấu Tổ chức (Structure)</div>
                    ...
                    <div className="flex items-center gap-3">
                        <select
                            ...
                            className="bg-[#FFFFFF] border border-slate-200 rounded-xl text-xs font-bold text-slate-900 focus:ring-2 focus:ring-[#2563EB]/20 py-2 px-4 outline-none"
                        >
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2 bg-[#FFFFFF] border border-slate-200 rounded-xl text-xs font-bold text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-[#2563EB]/20 w-64 outline-none"
                            />
                        </div>
                    </div>
                </div>
                        ...
                        <tbody className="divide-y divide-slate-100">
                            ...
                            {filteredDepartments?.map((dept: Department) => (
                                <tr key={dept.id} className="hover:bg-[#FFFFFF]/30 transition-colors">
                                    <td className="p-5">
                                        <div className="flex items-center gap-4">
                                            <div className="h-12 w-12 rounded-xl bg-[#FFFFFF] flex items-center justify-center font-black text-[#2563EB] shadow-sm transition-transform hover:rotate-12 border border-slate-200">
                                                <Building2 size={20} />
                                            </div>
                                            <div>
