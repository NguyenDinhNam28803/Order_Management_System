        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <select
              ...
              className="h-14 pl-12 pr-10 bg-[#F1F5F9] border border-[rgba(148,163,184,0.1)] rounded-2xl text-sm font-bold text-[#000000] focus:outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/5 transition-all appearance-none cursor-pointer min-w-[200px]"
            >
            ...
            return (
              <Link key={v.id} href={`/procurement/supplier-vetting/${v.id}`}>
                <div className="group flex items-center gap-4 rounded-xl border border-[#E2E8F0] bg-[#F1F5F9] p-4 hover:border-[#2563EB]/30 hover:bg-[#1C2128] transition-all cursor-pointer">
                  ...
                  <ChevronRight size={16} className="text-[#000000] group-hover:text-[#3B82F6] shrink-0 transition-colors" />
                </div>
              </Link>
            );
          })}
