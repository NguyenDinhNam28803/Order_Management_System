    ...
    const getStatusBadge = (status: DisputeStatus) => {
        switch (status) {
            ...
            case DisputeStatus.CLOSED:
                return <span className="px-2 py-1 bg-[#F1F5F9] text-slate-900 border border-[rgba(148,163,184,0.1)] rounded-full text-xs font-bold flex items-center gap-1 w-fit"><XCircle size={12}/> Đã đóng</span>;
            default:
                    ...
                    <div key={d.id} className="bg-[#F1F5F9] p-5 rounded-xl shadow-xl shadow-[#2563EB]/5 border border-[rgba(148,163,184,0.1)] hover:border-rose-500/20 transition-all group relative">
                        <div className="flex justify-between items-start mb-3">
                            ...
                            <div className="text-right text-xs text-slate-900">
                                ...
                                <p>Tài liệu: <span className="font-bold text-slate-900 uppercase">{d.relatedDocumentType}</span></p>
                            </div>
                        </div>
                        
                        <div className="bg-[#FFFFFF] p-3 rounded-xl text-sm text-slate-900 mb-4 line-clamp-2 italic border border-[rgba(148,163,184,0.1)]">
                            &quot;{d.reason}&quot;
                        </div>
