                ...
                <div className="p-8 bg-[#FFFFFF] border-b border-[rgba(148,163,184,0.1)] flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-[#000000]">
                                <ChevronDown size={12} />
                            </div>
                        </div>
                                ...
                                <tr key={user.id || i} className="hover:bg-[#FFFFFF]/50 transition-colors border-b border-[rgba(148,163,184,0.1)]">
                                    <td className="p-5">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="text-sm font-black text-[#000000] leading-tight">{user.fullName || user.name}</div>
                                                <div className="text-[10px] text-[#000000] font-bold flex items-center gap-1.5 mt-1 tracking-tight">
                                                    <Mail size={12} className="text-[#000000]" /> {user.email}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div className="flex flex-col gap-1">
                                            <div className="flex items-center gap-1.5 text-[#000000] font-bold">
                                                <Building size={12} className="text-[#000000]" />
                                                {typeof user.department === 'object' ? user.department?.name : (departments?.find(d => d.id === user.deptId)?.name || "Chưa có phòng ban")}
                                            </div>
                                            <div className="text-[10px] text-[#000000] italic bg-[#FFFFFF] w-fit px-2 py-0.5 rounded-md">
                                                {getJobTitle(user)}
                                            </div>
                                        </div>
                                    </td>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-[#000000] uppercase tracking-widest ml-1">Họ và tên</label>
                                        <input 
                                            required
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-[#000000] uppercase tracking-widest ml-1">Email nội bộ</label>
                                        <input 
                                            required
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-[#000000] uppercase tracking-widest ml-1">Vai trò hệ thống</label>
                                        <select 
                                            required
                                            value={formData.role}
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-[#000000] uppercase tracking-widest ml-1">Phòng ban</label>
                                        <select 
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-[#000000] uppercase tracking-widest ml-1">Chức danh</label>
                                        <input 
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-[#000000] uppercase tracking-widest ml-1">Mã nhân viên (Tự động nếu để trống)</label>
                                        <input 
