        ...
        <main className="animate-in fade-in duration-500 p-6 min-h-screen bg-[#FFFFFF] text-slate-900">
            <header className="mb-10 lg:flex items-end justify-between">
                <div>
                    ...
                    <p className="text-slate-900 font-medium">Toàn bộ hồ sơ các quyết định phê duyệt của bạn</p>
                </div>
                
                <div className="flex gap-4 mt-6 lg:mt-0">
                    <div className="flex bg-[#F1F5F9] rounded-2xl border border-[rgba(148,163,184,0.1)] p-1 shadow-sm">
                        <button className="px-4 py-2 text-[10px] font-black uppercase tracking-widest text-slate-900 bg-[#2563EB] rounded-xl transition-all shadow-sm">Hôm nay</button>
                                ...
                                <td className="px-6 py-5">
                                    <div className="flex items-center gap-2">
                                        {item.status === 'APPROVED' ? (
                                            <>
                                                <div className="h-5 w-5 rounded-full bg-emerald-500 text-slate-900 flex items-center justify-center">
                                                    <CheckCircle size={12} />
                                                </div>
                                            ...
                                            <>
                                                <div className="h-5 w-5 rounded-full bg-amber-500 text-slate-900 flex items-center justify-center">
                                                    <Clock size={12} />
                                                </div>
