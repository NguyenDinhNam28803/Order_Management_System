...
export default function PrivacyPage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#FFFFFF] p-6 text-center">
            <div className="bg-[#F1F5F9] p-12 rounded-3xl shadow-xl shadow-[#2563EB]/5 border border-[rgba(148,163,184,0.1)] max-w-md">
                ...
                <Link href="/" className="block w-full py-3 bg-[#2563EB] hover:bg-[#1D4ED8] text-slate-900 rounded-xl text-sm font-black uppercase transition-colors shadow-lg shadow-[#2563EB]/20">Về trang chủ</Link>
            </div>
        </div>
    );
}
