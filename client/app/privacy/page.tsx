...
export default function PrivacyPage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#FFFFFF] p-6 text-center">
            <div className="bg-[#F1F5F9] p-12 rounded-xl shadow-xl shadow-[#2563EB]/5 border border-[rgba(148,163,184,0.1)] max-w-md">
                <h1 className="text-2xl font-black text-[#0F172A] mb-4 uppercase tracking-tight">Chính sách Bảo mật</h1>
