    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sky-50 to-[#F3DDD6] flex items-center justify-center text-gray-900">
        <div className="text-center">
          ...
          <p className="text-gray-700 font-medium">Đang tải thông tin vận chuyển...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-white rounded-xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <div className="bg-sky-50 rounded-xl p-4 text-left text-sm space-y-2">
            <div className="flex justify-between">
              <span className="text-gray-600">Số vận đơn</span>
      ...
      <div className="max-w-2xl mx-auto space-y-5">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="px-6 py-4 grid grid-cols-2 md:grid-cols-3 gap-4 text-sm border-b border-gray-100">
            ...
            <div>
              <p className="text-gray-500 text-xs mb-0.5">Giao hàng trước</p>
            ...
            <div>
              <p className="text-gray-500 text-xs mb-0.5">Nhà cung cấp</p>
              <p className="font-medium text-gray-700">{grn.po.supplierName ?? "—"}</p>
            </div>
          </div>

          {grn.po.deliveryAddress && (
            <div className="px-6 py-3 flex items-start gap-2 text-sm text-gray-700 border-b border-gray-100">
          ...
          {(grn.po.contactPerson || grn.po.contactEmail) && (
            <div className="px-6 py-3 flex items-center gap-4 text-xs text-gray-600">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="px-6 py-5 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">Ngày xuất hàng</label>
              <input
                type="date"
                value={shippedAt}
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">Ngày giao dự kiến</label>
              <input
                type="date"
            ...
            <div className="md:col-span-2">
              <label className="block text-xs font-medium text-gray-700 mb-1">Ghi chú vận chuyển</label>
              <textarea
                rows={2}
          ...
          <div className="flex items-center gap-2 px-6 pb-5 text-xs text-gray-500">
