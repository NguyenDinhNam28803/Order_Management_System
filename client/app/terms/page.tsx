...
export default function PlaceholderPage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-bg-primary p-6 text-center">
            <div className="bg-bg-secondary p-12 rounded-xl shadow-xl border border-border max-w-md">
                ...
                <Link href="/" className="bg-[#2563EB] text-white block w-full py-3 rounded-xl font-bold hover:bg-[#1D4ED8] transition-all">Quay về Trang chủ</Link>
            </div>
        </div>
    );
}
