...
export default function CreateGRN() {
    ...
    const handleConfirm = async () => {
        ...
        createGRN({ poId: activePO.id, receivedItems } as unknown as import("../../../types/api-types").CreateGrnDto);
            ...
            {!activePO ? (
                <div className="space-y-4">
                    ...
                    <div className="bg-[#F1F5F9] rounded-xl border border-[rgba(148,163,184,0.1)] overflow-hidden">
                        ...
                        {filteredPos.length === 0 ? (
                            <div className="py-16 text-center text-slate-900 font-bold text-xs uppercase tracking-widest">
                                ...
                                <tbody>
                                    {filteredPos.map((po) => (
                                        <tr key={po.id} className="hover:bg-[#FFFFFF] cursor-pointer" onClick={() => handleSelectPO(po)}>
                                            ...
                                            <td className="font-bold text-slate-900">{po.supplier?.name || po.vendor || "—"}</td>
                ...
                <div className="space-y-8 fade-in">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 text-xs font-bold text-slate-900 hover:text-[#2563EB] transition-colors uppercase tracking-widest"
                    >
                    ...
                    <div className="bg-[#F1F5F9] text-slate-900 rounded-xl p-6 shadow-xl relative overflow-hidden flex flex-col md:flex-row justify-between items-center z-10 border border-[rgba(148,163,184,0.1)]">
                        ...
                        <div className="flex flex-col text-right mt-4 md:mt-0 relative z-10">
                            ...
                            <span className="text-xs text-slate-900 mt-2">Date: {activePO.createdAt || new Date().toLocaleDateString()}</span>
                        </div>
                    </div>
                                                    ...
                                                    <div className="flex items-start gap-4 p-4 border border-rose-500/20 bg-rose-500/5 rounded-xl">
                                                        ...
                                                        <div className="w-full space-y-3">
                                                            ...
                                                            <div className="grid grid-cols-2 gap-4">
                                                                <div>
                                                                    <label className="text-[10px] font-black uppercase text-slate-900 mb-1 block">Số lượng Lỗi/Hỏng</label>
                                                                    <input type="number" className="w-full bg-[#FFFFFF] border border-rose-500/20 rounded-lg px-3 py-2 text-black font-bold focus:outline-none focus:border-rose-500/30 text-slate-900" value={qData.failQty} onChange={e => handleQcChange(item.id, 'failQty', Number(e.target.value))} />
                                                                </div>
                                                                <div>
                                                            ...
                                                            <div className="grid grid-cols-2 gap-4 mt-2">
                                                                ...
                                                                <div>
                                                                    <label className="text-[10px] font-black uppercase text-slate-900 mb-1 block flex items-center gap-1"><UploadCloud size={10} /> Ảnh Bằng Chứng</label>
