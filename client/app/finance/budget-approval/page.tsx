    ...
    return (
        <main className="p-6 md:p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 min-h-screen bg-[#FFFFFF] text-slate-900">
            ...
            <div className="flex flex-col gap-2">
                ...
                <p className="text-sm font-medium text-slate-900 max-w-2xl">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-[#F1F5F9] p-4 rounded-2xl border border-[rgba(148,163,184,0.1)] shadow-xl shadow-[#2563EB]/5">
                <div className="relative flex-1 max-w-md w-full focus-within:ring-2 ring-[#2563EB]/20 rounded-xl transition-all">
                    ...
                    <input 
                        ...
                        className="w-full pl-11 pr-4 py-3 bg-[#FFFFFF] border-none rounded-xl text-sm font-medium text-slate-900 placeholder:text-slate-900 focus:ring-0"
                        value={searchTerm}
