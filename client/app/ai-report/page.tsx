        ...
        return (
            <div className="h-screen flex items-center justify-center bg-slate-50">
                <div className="text-center bg-white rounded-xl border border-[#E2E8F0] shadow-sm p-6 p-12! animate-in fade-in zoom-in duration-500">
                    ...
                    <p className="text-[#64748B] mb-8">Phiếu PR sẽ được chuyển sang trạng thái chờ phê duyệt chính thức. Đang quay lại trang chủ...</p>
                </div>
            </div>
        );
    }
        ...
        <main className="pt-16 px-8 pb-12">
            <div className="mt-8 flex justify-between items-end mb-8">
                <div>
                    ...
                    <p className="text-[0.8125rem] text-[#64748B] mt-1">Hệ thống đã phân tích 3 nhà cung cấp cho hạng mục &quot;Máy may công nghiệp&quot;.</p>
                </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                    ...
                    <div className="relative border-2 border-emerald-500 rounded-xl p-8 bg-emerald-50/30 overflow-hidden shadow-lg shadow-emerald-500/10">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-start justify-between gap-6">
                            ...
                            <div className="flex flex-col items-center justify-center p-6 bg-white border-2 border-emerald-100 rounded-xl shadow-sm min-w-[140px]">
                                <span className="text-[10px] font-black text-[#64748B] uppercase tracking-widest mb-1">Điểm tổng hợp</span>
                            ...
                            <tbody>
                                <tr className="bg-emerald-50/50 relative border-l-4 border-emerald-500">
                                    <td className="font-bold text-brand-primary">
                                        ...
                                        <span className="block text-[0.6875rem] font-black text-emerald-500 uppercase tracking-widest mt-1">Đề xuất</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td className="text-right font-bold text-slate-900">205,000,000</td>
                                    <td className="text-center font-bold text-slate-600">12 ngày</td>
                                    <td className="text-center font-black text-amber-500">75/100</td>
                                    <td className="text-center font-black text-slate-700 text-lg">82</td>
                                ...
                                <tr>
                                    ...
                                    <td className="text-right font-bold text-slate-900">225,000,000</td>
                                    ...
                                    <td className="text-center font-black text-slate-700 text-lg">80</td>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white rounded-xl border border-[#E2E8F0] shadow-sm p-6 shadow-xl shadow-erp-navy/5">
                        <h3 className="text-xs font-bold uppercase tracking-widest text-[#64748B] mb-6 flex items-center gap-2">
                        ...
                        <div className="space-y-4 mb-6">
                            <label className={`flex items-start gap-3 p-4 border-2 rounded-xl cursor-pointer transition-all ${selection === 'AI' ? 'border-emerald-500 bg-emerald-100/50' : 'border-slate-200 bg-white hover:border-slate-300'}`}>
                                ...
                                <div>
                                    ...
                                    <div className="text-[10px] text-[#64748B] font-bold mt-0.5">Chọn Cơ Khí Nhật Bản (Juki VN). Quy trình sẽ tiếp tục tự động sang bước duyệt.</div>
                                </div>
                            </label>
