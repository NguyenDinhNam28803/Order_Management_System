    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 p-6 text-center">
            <div className="bg-white p-12 rounded-3xl shadow-xl border border-slate-100 max-w-md">
                <div className="h-16 w-16 bg-blue-50 text-erp-blue rounded-3xl mx-auto flex items-center justify-center mb-6">
                ...
                <p className="text-slate-500 mb-8 font-medium">Bạn cần trợ giúp xử lý PR/PO? Vui lòng gửi email cho đội ngũ hỗ trợ kỹ thuật hoặc quay lại trang chủ.</p>
