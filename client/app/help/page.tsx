...
export default function HelpPage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 p-6 text-center">
            <div className="bg-white p-12 rounded-xl shadow-xl border border-slate-100 max-w-md">
                <div className="h-16 w-16 bg-[#F9EFEC] text-erp-blue rounded-xl mx-auto flex items-center justify-center mb-6">
                ...
                <h1 className="text-2xl font-black text-brand-primary mb-4 uppercase tracking-tight">Trung tâm Hỗ trợ</h1>
